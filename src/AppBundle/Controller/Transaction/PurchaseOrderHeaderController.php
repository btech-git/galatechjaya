...
class PurchaseOrderHeaderController extends Controller
{
     ...
     * @Method("POST")
     * @Security("has_role('ROLE_PURCHASE_ORDER_HEADER_NEW') or has_role('ROLE_PURCHASE_ORDER_HEADER_EDIT') or has_role('ROLE_PURCHASE_ORDER_HEADER_DELETE')")
     */
     ...
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_PURCHASE_ORDER_HEADER_NEW')")
     */
     ...
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_PURCHASE_ORDER_HEADER_EDIT')")
     */
     ...
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_PURCHASE_ORDER_HEADER_DELETE')")
     */
     ...
     * @Method("GET")
     * @Security("has_role('ROLE_PURCHASE_ORDER_HEADER_NEW') or has_role('ROLE_PURCHASE_ORDER_HEADER_EDIT')")
     */
