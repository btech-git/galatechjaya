...
class ProductCategoryController extends Controller
{
    ...
    /**
     * @Route("/{id}", name="master_product_category_show", requirements={"id": "\d+"})
     * @Method("GET")
     * @Security("has_role('ROLE_MASTER')")
     */
    ...
    /**
     * @Route("/{id}/edit", name="master_product_category_edit", requirements={"id": "\d+"})
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_MASTER')")
     */
    ...
    /**
     * @Route("/{id}/delete", name="master_product_category_delete", requirements={"id": "\d+"})
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_MASTER')")
     */
