...
class ProductController extends Controller
{
    ...
    /**
     * @Route("/{id}", name="master_product_show", requirements={"id": "\d+"})
     * @Method("GET")
     * @Security("has_role('ROLE_MASTER')")
     */
    ...
    /**
     * @Route("/{id}/edit", name="master_product_edit", requirements={"id": "\d+"})
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_MASTER')")
     */
    ...
    /**
     * @Route("/{id}/delete", name="master_product_delete", requirements={"id": "\d+"})
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_MASTER')")
     */
