...
class PaymentTypeController extends Controller
{
    ...
    /**
     * @Route("/{id}", name="master_payment_type_show", requirements={"id": "\d+"})
     * @Method("GET")
     * @Security("has_role('ROLE_MASTER')")
     */
    ...
    /**
     * @Route("/{id}/edit", name="master_payment_type_edit", requirements={"id": "\d+"})
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_MASTER')")
     */
    ...
    /**
     * @Route("/{id}/delete", name="master_payment_type_delete", requirements={"id": "\d+"})
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_MASTER')")
     */
