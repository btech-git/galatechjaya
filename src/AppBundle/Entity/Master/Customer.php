...
class Customer
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Account", inversedBy="customerReceivables")
     * @Assert\NotNull()
     */
    private $accountReceivable;
    /**
     * @ORM\ManyToOne(targetEntity="Account", inversedBy="customerDownpayments")
     * @Assert\NotNull()
     */
    ...
    public function getAccountReceivable() { return $this->accountReceivable; }
    public function setAccountReceivable(Account $accountReceivable = null) { $this->accountReceivable = $accountReceivable; }
